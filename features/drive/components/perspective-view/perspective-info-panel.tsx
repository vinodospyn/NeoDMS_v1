...
export function PerspectiveInfoPanel({ selectedNode }: PerspectiveInfoPanelProps) {
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col bg-background">
      <ScrollArea className="min-h-0 flex-1">
        <Tabs defaultValue="info" className="gap-0 p-3">
          ...
          <TabsContent value="info" className="mt-3 space-y-3 outline-none">
            <SharedWithCard />
            <DriveDetailPropertiesSection items={propertyItems} />
          </TabsContent>
          <TabsContent value="header-properties" className="mt-3 outline-none">
            <DriveDetailPropertiesSection items={propertyItems} />
          </TabsContent>
          <TabsContent value="comments" className="mt-3 outline-none">
            <p className="rounded-xl border border-dashed border-border/60 bg-background px-3 py-8 text-center text-xs text-muted-foreground">
